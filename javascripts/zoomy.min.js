			    ...
			    image : function (image, zoom) {
				    ...
				    if (zoom.find('img').attr('src') !== image) {
					    zoom.find('img').attr('src', image).load(function () {
						    ...
						    zoom.append(assets)
							    .css({
								    'background-image': "url('images/distancehouses-upclose.jpg')"
							    })
							    .find('img')
							    .remove();
						    ...
						    var eventlist = [],	//List of Actual Events
							    ...
							    zoomStart = function () {
								    change.enter(ele, zoom);
								  	if (!(options.drag)) {
								  		...
								  		ele.find('.zoomy').draggable({
								  			containment: ele,
								  			drag: function () {
								  				ele.bind('drag', zoomMove);
								  			},
								  		});
								  	}
							    ...
							    events = {		//List of Possible Events
								    event: function (e) {
									    ...
									    } else if (!options.drag && ZoomyS[i].state === 1 && event !== 'mouseover' && event !== 'mouseenter') {
										    zoomStop(0);
